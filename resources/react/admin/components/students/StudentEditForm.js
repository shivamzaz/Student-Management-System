...
var StudentsEditForm = React.createClass({
  ...
  componentWillMount: function(){
    axios.get(config.base_url + '/api/v1/interests')
      ...
      //lodash
    axios.get(config.base_url + '/api/v1/students/' + this.props.routeParams.studentId)
        .then(response => {
  ...
  _onSubmit: function(e){
      ...
      axios.patch(config.base_url +'/api/v1/students/' + this.props.routeParams.studentId, {  //this.props.routeParams.studentId
      ...
      <div id="content">
              ...
              <div className={Form.formGroupClass(this.state.errors.gender)}>
                ...
                <div className="col-sm-10 col-md-8">
                  <div className="radio" >
                    <label>
                      <input type="radio" name="gender" value="1" onChange={this._onChange} checked={this.state.gender == 1 ? true : false}  />
                      <span>Male</span>
                    </label>
                  </div>
                  <div className="radio" >
                    <label>
                      <input type="radio" name="gender" value="2" onChange={this._onChange} checked={this.state.gender == 2 ? true : false} />
                      <span>Female</span>
                    </label>
                  </div>
